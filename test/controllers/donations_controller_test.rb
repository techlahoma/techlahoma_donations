...
class DonationsControllerTest < ActionController::TestCase
  ...
  test "should create donation" do
    assert_difference('Donation.count') do
      post :create, donation: { amount: @donation.amount, email: @donation.email, first_name: @donation.first_name, last_name: @donation.last_name }
    end
  ...
  test "should update donation" do
    patch :update, id: @donation, donation: { amount: @donation.amount, email: @donation.email, first_name: @donation.first_name, last_name: @donation.last_name }
    assert_redirected_to donation_path(assigns(:donation))
  end
